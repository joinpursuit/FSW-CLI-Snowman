...
// for (let guesses = 6; 0 < guesses; guesses--) {
//   for (let guesses = 5; 0 <= guesses; guesses--) {
//     let input = readline.question('Please enter your guess: ');
...
// }
  ...
  // for (let r = 0; r < oneWord.length; r++) {
  //   if (oneWord[r] === guesses) {
  //     answerArray[r] = guesses;
  //     remainingLetters--;
  //
  //     let letterRemains = allOfTheWords.length;
  //     while (letterRemains >= 0) {
...
let answerArray =selectedWordBlanks
      ...
      while (guess >= 0) {
        ...
        if (selectedWord.includes(input)) {
          console.log('yes');
          for(let r = 0; r < selectedWord.length; r++)  {
            if (selectedWord[r] === input){
              answerArray[r] = input
}
}
} else {
...
console.log(guessedLetters);
    ...
    //console.log(`These are your previously guessed letter: ${guessedLetters.split('')}`)
    // Animate man
