...
let balloon6 = [
  '___💙💙___💙💙___________________________________💙💙___💙💙________',
  '__💙💙💙_💙💙💙__________________________________💙💙💙_💙💙💙_______',
  ...
  '______________§_____💜💜💜_💜💜💜____💜💜💜_💜💜💜___§_______________',
  '_______________§____💜💜💜💜💜💜_____💜💜💜💜💜💜___§________________',
  '___💛💛___💛💛___§______💜💜💜__________💜💜💜__§____💛💛___💛💛_____',
  '__💛💛💛_💛💛💛___§_______💜______________💜__§_____💛💛💛_💛💛💛____',
  '___💛💛💛💛💛💛___§________§______________§___§_____💛💛💛💛💛💛_____',
  '____💛💛💛💛💛____§________§____________§____§_______💛💛💛💛💛_____',
  '______💛💛💛_____§_________§___________§____§__________💛💛💛_______',
  '________💛________§________§___________§____§___________💛________',
  '_________§________§_______§_________§_____§____________§_________',
  '____________§________§____§________§____§_____________§__________',
  '________________§______§___§______§___§______________§____________']

let balloon5 = [
  '________________________________________________💙💙___💙💙______',
  '_______________________________________________💙💙💙_💙💙💙_____',
  '_______________________________________________💙💙💙💙💙💙______',
  '________________________________________________💙💙💙💙💙_______',
  '__________________________________________________💙💙💙__________',
  '____________________________________________________💙___________',
  '____________________________________________________§___________',
  '_____________________💜💜__💜💜 ______💜💜__💜💜______§___________',
  '____________________💜💜💜_💜💜💜____💜💜💜_💜💜💜___§_____________',
  '____________________💜💜💜💜💜💜_____💜💜💜💜💜💜___§______________',
  '_____________________💜💜💜💜💜_______💜💜💜💜💜__§_______________',
  ...
  '______💛💛💛_______________§___________§____§__________💛💛💛_____',
  '________💛_________________§__________§___§______________💛______',
...
let balloon4 = [
  ...
  '___💛💛___💛💛__________💜💜💜__________💜💜💜____§________________',
  '__💛💛💛_💛💛💛___________💜______________💜___§_________________',
...
let balloon3 = [
  ...
  '___💛💛💛💛💛💛____________§__________________§___________________',
  '____💛💛💛💛💛_____________§_________________§____________________',
  '______💛💛💛_______________§________________§____________________',
...
let balloon1 = [
  ...
  '________________________________________________________________',
  '________________________________________________________________',
  '_____________________💜💜__💜💜 _________________________________',
...
const start = () => {
  console.log('');
  console.log('');
  console.log(paint.rainbow(`Welcome to Balloon Pop:`));
  console.log(`A cool new guessing game`)
  ...
  for (; remainingLetters > 0 && guess > 0;) {
    ...
    console.log('');
    graphic()
    console.log(`You have ${paint.red.bold(guess)} guess(es) remaining.`);
    console.log('');
    console.log('');
    if (guess > 0) {
      console.log('');
      ...
      if (guess === 0) {
        ...
        for (let k = 0; k < selectedWord.length; k++) {
          ...
          for (; remainingLetters === 0; remainingLetters--) {
            ...
            say.stop();
            if (guess === 6) {
              say.speak(`Congratulations, you correctly guessed the word ${selectedWord.join('')},     and all of your balloons survived!      Press the up arrow and return button to play again.`);
            } else {
              say.speak(`Congratulations, you correctly guessed the word ${selectedWord.join('')},     and ${guess} of your balloons survived!      Press the up arrow and return button to play again.`);
            }
            console.log('');
            console.log('');
          }
        }
        console.log(paint.bold(answerArray.join('').toUpperCase()));
      } else {
        console.log('');
        guess--;
        ...
        if (guess === 0) {
          ...
          console.log(`You have ${paint.red.bold(guess)} guess(es) remaining.`);
          say.stop();
          say.speak(`All your balloons popped. Better luck next time.     The word was ${selectedWord.join('')}.      Press the up arrow and return to play again.`)
          console.log('');
          console.log('');
          console.log(`The word was ${paint.red.bold(selectedWord.join('').toUpperCase())}`);
          console.log('');
          console.log('');
          youLose();
          console.log('');
