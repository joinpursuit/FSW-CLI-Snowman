...
// dictionaryIndexNum = (zero, numOfAllWords) => {
//     let iNum = Math.floor(Math.random() * (numOfAllWords - zero) + 1)
//     return iNum;
// }
// wordGrab = () => {
...
// let word  = wordGrab()
//     console.log(word)
// let lifeNum = `Chances left: ${word.length}`
// console.log(lifeNum)
    
// let letters = 'abcdefghijklmnopqrstuvwxyz'
// const letters = letters.split('')
// console.log(lettersToArray)
...
//         if (guessIsValid(input) === lettersToArray) {
...
let word = wordGrab().split('')//turn our new word into letters and store in a variable
console.log(word)
...
let letterCheck = word.some((elem) => {
    if (input === elem) {
        return true
    } 
})
