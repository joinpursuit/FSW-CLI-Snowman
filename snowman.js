...
const StartGame = () => {
  console.log("Guess the mystery word " + stats.name + " .\n");
...
function gameLoop() {
  numOfChar();
  while (randomWord !== stats.charNumArr.join("") && stats.numOfGuesses !== 0) {
    console.log(stats.charNumArr.join(" "));
    getValidLetterGuess();
...
function lostGame() {
  console.log(" Sorry, " + stats.name + " you lost!");
...
function guessCount() {
  ...
  if (stats.numOfGuesses === 1) {
    console.log("You have " + stats.numOfGuesses + " guess remaining."); // 1 it's equal to singular
  } else {
    console.log("You have " + stats.numOfGuesses + " guesses remaining."); // plural
  }
  lettersGuessed();
}
...
function wonGame() {
  console.log("Congrats " + stats.name + " you won!");
  console.log("You guessed " + stats.totalGuesses + " times.");
}
