...
// let letterCount = dictionary.length;
...
const startGame = () => {
  ...
  console.log("The word you're trying to guess is: " + stats.answer);
...
const gameLoop = () => {
  ...
  console.log(`You got ${stats.guessCount - stats.wrongCount} guesses correct.`)
    ...
    // while ((stats.answer = stats.correctAnsr)) {
    //   console.log(
    //     "Wow great job, you guessed all the letters in the word! You win!"
    //   );
    //   console.log(`It took you ${guessesMade} guesses`);
    //   console.log("The word is: " + stats.correctAnsr);
    //   let question = readline.keyInYNStrict("Would you like to play again?");
    //   if (question) {
