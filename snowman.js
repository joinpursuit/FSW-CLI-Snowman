...
//Create a messge with the number of guesses remaining.

//loop: while the number of guess is less than or equal to 8, keep testing the letters against the array element/the word. 

//a loop where user input is being taken in and then two different arrays are being updated

//take the result of the random string function, then test user input against that. 
//question: how do you do that on a micro-level, for a single letter? 


//question: should the entire game go inside of one function? The playGame() function? 