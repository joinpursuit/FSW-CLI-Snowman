...
const startGame = () => {
stats.nameInput = readline.question('What is your name?\n')
let leave = `Aww man, that\'s too bad. Hope to see you soon ${stats.nameInput}!`
...
leave = `Aww man, that\'s too bad. Hope to see you soon ${stats.nameInput}!`
if(leave){
  console.log(leave);
  process.exit();
}
...
let lost = `Sorry ${stats.nameInput}, you ran out of guesses!`
  console.log(lost)
...
function wonGame(){
console.log('You\'re so smart ' + stats.nameInput +  ',' + ' it took you ' + stats.guessedLetterArr.length + ' guesses to guess the correct word!')
};
