...
let win = () => {
  if (gameVars.gBoard.every((v, i) => v === gameVars.word.split("")[i])) {
    console.log(
      `Congratulations, you win! It took you ${gameVars.tGuesses} guesses!'`
    );
    process.exit();
  }
};
...
const intro = () => {
  console.log(
    "Welcome to Snowman! We have picked a random word and it is up to you to guess the letters to find out the word!\nYou only have 10 times to put in a wrong letter before you lose so watch out!"
  );
