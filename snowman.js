...
const startGame = () => {
  ...
  nameOfPlayer = readline.question(`What is your name? `);
  console.log(`Ok ${nameOfPlayer}. Let's start.`);
  console.log(ranWordFunction());
}
const wrongGuessFunction = () => { //if you enter the wrong guess or you lose
...
const ranWordFunction = () => { //shows the random word in ---
  randWord = dictionary[Math.floor(Math.random() * dictionary.length)];
  ranWordArray = randWord.split('')
...
const guessTheLetters = () => { // lets tou guess the letter and tell you how many guesses you have left.
  if (numberOfGuesses.maxGuesses === 1) {
    console.log(`You now have ${numberOfGuesses.maxGuesses} wrong guess left.`)
  } else {
    console.log(`You now have ${numberOfGuesses.maxGuesses} wrong guesses left.`)
  }
  ...
  correctAndWrongGuesses(guess)
}
const correctAndWrongGuesses = (guess) => { //directs you depending on your guess
  if (ranWordArray.includes(guess)) {
    correctGuessFunction(ranWordArray, guess);
  } else {
    wrongGuessFunction()
  }
}
const correctGuessFunction = (ranWordArray, guess) => {//adds letter to the random word if correct and give the winning message 
  let indexWord = []
  ...
  if (showAnswer.indexOf('_') < 0){
    console.log(`Congratulations ${nameOfPlayer}!! you guessed it in ${totalOfGuesses} guesses.`)
  } else {
    guessTheLetters()
  }
}
