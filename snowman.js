...
const guessLetter = (letter) => {
  ...
  letter = letter.toLowerCase() 
    if(word.includes(letter)) {
      ...
      wrongGuess += letter
      console.log("\n You have guessed an incorrect letter , try again!\n")
      chances--;
...
const startGame = () => {
  ...
  chances = 10;
  console.log(`You have ${chances} chances to play` )
let dash = ""
...
// Welcome
const welcome = () => {
  console.log("\n Hello, welcome to the snowman game! \n ")
  console.log("\n In this game of snowman, you are required to guess letters until you guess the correct word!\n")
