...
let stats = {
  ...
  guessedLetters: [], 
  trackedWord: '',
  randomWordAns: randomWordPicker(),
...
function currentword(){
  word = randomWordAns.split('') //apple [a,p,p,l,e]
  for (let i = 0; i < randomWordAns.length; i++) {
    stats.guessedLetters.push('_')
  }
  console.log(word)
}
