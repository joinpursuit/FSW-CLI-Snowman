...
const loseGame = () => {
  ...
  console.log(chalk.redBright(`Sorry, You didn't guess the mystery word: `+ (chalk.yellowBright(randomWord) + `\nTry again next time!`)))
  leaveGame()
}
...
const winGame = () => {
  console.log(chalk.redBright.underline("=================================================="))
  console.log(chalk.redBright.underline("Congrats! You did it! You've figured out the word" + (chalk.yellowBright(randomWord) + "in the Snowman word guessing game!")))
}
...
const startGame = () => { 
  ...
  if (readlineSync.keyInYNStrict(chalk.white.bold("\nAre you ready to play Snowman?"))){
    ...
    console.log(chalk.redBright.bold("Please enter a letter to correspond with the given underscores (_) below!\n"))
    } else {
...
// console.log(hideRandomWord().join(' '))
// console.log(randomWord)
// console.log(hideRandomWord()) 
...
/////////////////////////////////////////
    ...
    console.log("==================================================")
    console.log("Your letter choice was => " + input)
