...
let guessCount = 5;
let guessedLetters = [];
let willRename = showGameBoard();

function startGame() {
  if (readline.keyInYN(`Would you like to play Snowman?\n`)) {
    guessCounter();
  }
}
...
function showGameBoard() {
  ...
  console.log(Object.values(blankedOutWord).join(" "));
