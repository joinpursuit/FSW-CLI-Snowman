...
![Snowman Gif](https://github.com/mohsinali678/FSW-CLI-Snowman/blob/master/Snowman_Game.gif)
...
Copy the user stories from the Trello board [here](https://trello.com/b/TQ9FfpbU/cli-snowman-project) into your own board.
