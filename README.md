...
Copy the user stories from the Trello board [https://trello.com/b/s9s8ioD7/poonam-dass-project-board-2](https://trello.com/b/8OErA3xI/command-line-snowman-project-plan) into your own board.
