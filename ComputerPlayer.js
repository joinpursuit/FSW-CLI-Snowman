...
class ComputerPlayer {
    ...
    revealLetter(){
        let userInput = readline.question("ENTER A LETTER")

        this.getWord.forEach((el) => {
            if(userInput.toLowerCase === el){
                userInput = el
            }
        })
        return userInput
    ...
    isGuessValid(userInput) {
        ...
        if (!userInput.match(regex)) {
            ...
            return this.board = this.getWord.map((el, i) => {
                if(userInput === el) {
                    return el[i]
    ...
    revealWord(){
        console.log("NICE TRY THE WORD YOU ARE LOOKING FOR IS " + this.getWord + ".")
    }
    


}
let com = new ComputerPlayer()
// console.log(com.getWordLength())
console.log(com.setUpBoard())
