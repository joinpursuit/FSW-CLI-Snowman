let allCategories = {
    ...
    movies: ["la la land", "whiplash", "lord of the rings", "jaws", "alien"],
    tvShows: ["game of thrones", "the wire"],
    miscellaneous: ["addition", "advertisement", "able", "with", "wound", "yellow", "young", "yesterday", "against"],
    musicArtists: ["eminem", "guns n roses", "kyle"]
}
