...
let allCategories = {
    cats: ["movies", "tvShows", "misc", "musicArtists"],
    movies: ["la la land", "whiplash", "lord of the rings", "jaws", "alien", "godfather", "the dark knight", "star wars", "pulp fiction", "inglorious bastards", "et", "forrest gump", "casablanca", "jurassic park", "titanic", "back to the future", "the shawshank redemption", "psycho", "schindlers list", "the matrix", "goodfellas", "the departed", "silence of the lambs", "rocky", "avatar", "the wixard of oz", "fight club", "the exorcist", "inception", "the avengers", "snow white", "cinderella", "moana", "coco", "toy story", "aladdin", "mulan", "booksmart", "lion king", "die hard"],
    tvShows: ["game of thrones", "the wire", "breaking bad", "the sopranos", "the simpsons", "family guy", "seinfeld", "friends", "the office", "parks and recreation", "mad men", "cheers", "arrested development", "saturday night live", "the walking dead", "the big bang theory", "mash", "south park", "curb your enthusiam", "portlandia", "the x files", "i love lucy", "buffy the vampire slayer", "twin peaks", "the twilight zone", "black mirror", "stranger things", "on my block", "daredevil", "luke cage", "modern family", "frasier", "the middle", "doctor who", "orange is the new black", "freaks and geeks", "dexter", "bojack horseman", "sex and the city"],
    misc: allTheWords,
    musicArtists: ["eminem", "guns n roses", "kyle", "michael jackson", "elvis presley", "madonna", "lady gaga", "elton john", "drake", "lil wayne", "billy joel", "bruce springsteen", "taylow swift", "selena gomez", "mariah carey", "whitney houston", "prince", "beyonce", "stevie wonder", "david bowie", "britney spears", "paul mccartney", "the beatles", "jayz", "rihanna", "ed sheeran", "kanye west", "celine dion", "justin bieber", "tupac", "biggie smalls", "adele", "frank sinatra", "jimi hendrix", "katy perry", "foo fighters", "nirvana", "pink", "my chemical romance", "john lennon", "james brown", "ozzy osbourne", "bruno mars", "carlos santana", "bad bunny", "fall out boy"]
}
